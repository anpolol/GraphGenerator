...
class TuneParameters:
    ...
    def objective(self, args: Dict[str, Any]) -> Dict[str, Any]:
        ...
        sample_labels_items = random.choices(list(range(int(args['L']))), k=int(args['N']))
        ...
        generator = SBM(vertices, degree_dist, int(args['number_of_groups']), probs, int(args['N']))

        agm = AGM(degree_dist, args['assort_corr_in'], args['assort_corr_between'], int(args['L']))
